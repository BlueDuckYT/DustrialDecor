...
public class MetalScaffoldingItem extends ScaffoldingItem {
    public MetalScaffoldingItem(Block p_i50039_1_, Properties p_i50039_2_) {
    ...
    public BlockItemUseContext getBlockItemUseContext(BlockItemUseContext context) {
        ...
        if (blockstate.getBlock() != block) {
            return ScaffoldingBlock.func_220117_a(world, blockpos) == 128 ? null : context;
        } else {
            Direction direction;
